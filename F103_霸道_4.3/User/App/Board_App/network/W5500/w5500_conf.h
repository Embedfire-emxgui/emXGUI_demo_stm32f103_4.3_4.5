...
/*定义SPI2作为W5500的硬件接口*/
#define WIZ_SCS									GPIO_Pin_9								/*定义W5500的片选管脚*/
...
#define WIZ_GPIO_PORT							GPIOB									/* GPIO端口 */
#define WIZ_GPIO_CLK							RCC_APB2Periph_GPIOB					/* GPIO端口时钟 */
#define WIZ_SPI									SPI2
#define WIZ_SPI_CLK								RCC_APB1Periph_SPI2
...
#ifdef  STM32F103ZET6 
	#define WIZ_RESET_INT_PORT					GPIOG									/* GPIO端口 */
	#define WIZ_RESET_INT_CLK					RCC_APB2Periph_GPIOG					/* GPIO端口时钟 */
...
#ifdef STM32F103VET6    
	#define WIZ_RESET_INT_PORT					GPIOC									/* GPIO端口 */
	#define WIZ_RESET_INT_CLK					RCC_APB2Periph_GPIOC					/* GPIO端口时钟 */
...
uint8 set_w5500_ip(void);																		/*配置W5500的IP地址*/
