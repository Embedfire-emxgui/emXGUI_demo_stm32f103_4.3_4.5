...
static void FIFO_GPIO_Config(void)
{
    GPIO_InitTypeDef GPIO_InitStructure;
		...
		/* 1W LED 灯控制 */
	  macOV7725_XCLK_SCK_APBxClock_FUN ( macOV7725_XCLK_GPIO_CLK, ENABLE );
		GPIO_InitStructure.GPIO_Pin = macOV7725_XCLK_GPIO_PIN;
	  GPIO_InitStructure.GPIO_Mode  = GPIO_Mode_Out_PP;
    GPIO_InitStructure.GPIO_Speed = GPIO_Speed_50MHz;	
		GPIO_Init(macOV7725_XCLK_GPIO_PORT, &GPIO_InitStructure);

		GPIO_SetBits(macOV7725_XCLK_GPIO_PORT, macOV7725_XCLK_GPIO_PIN);
...
static void VSYNC_GPIO_Configuration(void)
{
	  ...
	  macOV7725_VSYNC_SCK_APBxClock_FUN ( macOV7725_VSYNC_GPIO_CLK|RCC_APB2Periph_AFIO, ENABLE );	  /*PA0---VSYNC*/
